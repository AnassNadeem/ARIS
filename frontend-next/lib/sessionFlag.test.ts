...
describe("resolveSessionFlag + red-flag playback compression", () => {
  const field: RaceField = {
    ...
    laps: [
      { lap: 1, driver: "NOR", position: 1, gap_to_leader_s: 0, gap_ahead_s: 0, compound: "M", tyre_life: 1, stint_number: 1, pit_this_lap: false, is_dnf: false, is_dsq: false, track_status: "1", lap_time_s: 90 },
      { lap: 2, driver: "NOR", position: 1, gap_to_leader_s: 0, gap_ahead_s: 0, compound: "M", tyre_life: 2, stint_number: 1, pit_this_lap: false, is_dnf: false, is_dsq: false, track_status: "1", lap_time_s: 90 },
      { lap: 3, driver: "NOR", position: 1, gap_to_leader_s: 0, gap_ahead_s: 0, compound: "M", tyre_life: 3, stint_number: 1, pit_this_lap: false, is_dnf: false, is_dsq: false, track_status: "5", lap_time_s: 150 },
      { lap: 4, driver: "NOR", position: 1, gap_to_leader_s: 0, gap_ahead_s: 0, compound: "M", tyre_life: 4, stint_number: 1, pit_this_lap: false, is_dnf: false, is_dsq: false, track_status: "1", lap_time_s: 1948 },
      { lap: 5, driver: "NOR", position: 1, gap_to_leader_s: 0, gap_ahead_s: 0, compound: "M", tyre_life: 5, stint_number: 1, pit_this_lap: false, is_dnf: false, is_dsq: false, track_status: "1", lap_time_s: 90 },
    ],
    stints: [],
    weather: [],
    race_control: [
